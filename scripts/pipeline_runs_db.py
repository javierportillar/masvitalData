...
Uso:
    python scripts/pipeline_runs_db.py start-run --pipeline run_all --triggered-by scheduled
    ...
    python scripts/pipeline_runs_db.py capture-layer-stats --run-id 1 --layer bronze
"""
...
def _get_conn() -> duckdb.DuckDBPyConnection:
    ...
    for attempt in range(3):
        try:
            ...
            break  # salió bien, salimos del loop
...
def main() -> None:
    ...
    p5.add_argument("--db-path", default="out/masvital_gold.duckdb",
