...
No hardcodea tenant — las tablas se llaman gold_* sin prefijo.
"""
...
def mart_productos_dormidos(con: duckdb.DuckDBPyConnection) -> None:
    con.execute("""
        ...
        SELECT
            ...
            MAX(fvd.business_date) AS ultima_fecha_venta,
            CURRENT_DATE - MAX(fvd.business_date) AS dias_sin_venta
        FROM silver_dim_producto dp
